...
public class Profesor_Prestamos extends javax.swing.JFrame {

    Profesor profesor;
    public Profesor_Prestamos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 190, 110, 50));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Ingresamos email del Profesor para mostrar Prestamos.
        if (!Biblioteca.getInstancia().getListaProfesores().isEmpty()) {
            String correoPro = correo.getText();
            for(Profesor p:Biblioteca.getInstancia().getListaProfesores()) {
                if (p.getCorreo().equals(correoPro)) {
                    profesor = p;
                    break;
                }
            }
            ...
            if (profesor != null) {
                Resultado_Profesor_Prestamo v1 = new Resultado_Profesor_Prestamo(profesor);
                v1.setVisible(true);
                this.setVisible(false);
            }
            
        } else {
            JOptionPane.showMessageDialog(this, "Lista de Profesores vacia.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Profesor_Prestamos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Profesor_Prestamos().setVisible(true);
            }
        });
    }
