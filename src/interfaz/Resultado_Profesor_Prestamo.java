...
public class Resultado_Profesor_Prestamo extends javax.swing.JFrame {

    public Resultado_Profesor_Prestamo(Profesor profesor) {
        initComponents();
        this.setLocationRelativeTo(null);
        String datos = "";
        //Obtengo sus prestamos
        for(Prestamo p:Biblioteca.getInstancia().getListaPrestamos()){
            if (p.getUsuario().equals(profesor)) {
        ...
        jTextArea1.setText("Profesor: " + profesor.getNombreUsuario() + "\n"+ datos);
    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(34, 30, 320, 330));
